...
import { ArrowLeft, Loader2, ShieldOff, ShieldCheck, DollarSign, TrendingUp, Activity } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard icon={DollarSign} label="Balance" value={fmt(user.balance)} color="gold" />
