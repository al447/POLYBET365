...
export const authAPI = {
  googleAuth: (credential, referralCode) => api.post('/auth/google', { credential, referralCode }),
  walletAuth: (data) => api.post('/auth/wallet', data),
  sendEmailCode: (email) => api.post('/auth/email/send-code', { email }),
  verifyEmailCode: (email, code, referralCode) => api.post('/auth/email/verify', { email, code, referralCode }),
