...
// Default token decimals. NOTE: BSC USDC/USDT use 18 decimals — callers must check
// the chain context. The auto-indexer uses Etherscan's per-tx `tokenDecimal` field
// so this map is only a fallback for legacy verification paths.
