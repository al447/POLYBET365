...
const pendingDepositSchema = new mongoose.Schema(
  {
    ...
    source: { type: String, enum: ['manual', 'indexer', 'moonpay', 'auto-verified', 'auto-indexer', 'manual-admin'], default: 'manual' },
    provider: { type: String, enum: ['manual', 'moonpay'], default: 'manual' },
